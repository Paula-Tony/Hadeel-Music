...
(function ($) {
  ...
  var portfolio = {
    ...
    popup_video: function () {
      if ($(".testimonial_icon_15 .video").length > 0) {
        $(".testimonial_icon_15 .video").magnificPopup({
          type: "iframe",
          iframe: {
            markup:
            ...
            patterns: {
              youtube: {
                index: "youtube.com/",
                id: "v=",
                src: "https://www.youtube.com/embed/np5n7zhE-wQ",
              },
            },
          },
          // other options
      ...
      if ($(".testimonial_icon_14 .video").length > 0) {
        $(".testimonial_icon_14 .video").magnificPopup({
          type: "iframe",
          iframe: {
            markup:
              '<div class="mfp-iframe-scaler">' +
            ...
            patterns: {
              youtube: {
                index: "youtube.com/",
                id: "v=",
                src: "https://www.youtube.com/embed/BlIoWu1OuH0",
              },
            },
          },
          // other options
      ...
      if ($(".testimonial_icon_13 .video").length > 0) {
        $(".testimonial_icon_13 .video").magnificPopup({
          type: "iframe",
          iframe: {
            markup:
              '<div class="mfp-iframe-scaler">' +
            ...
            patterns: {
              youtube: {
                index: "youtube.com/",
                id: "v=",
                src: "https://www.youtube.com/embed/SllqN4hH15k",
              },
            },
          },
          // other options
      ...
      if ($(".testimonial_icon_12 .video").length > 0) {
        $(".testimonial_icon_12 .video").magnificPopup({
          type: "iframe",
          iframe: {
            markup:
              '<div class="mfp-iframe-scaler">' +
            ...
            patterns: {
              youtube: {
                index: "youtube.com/",
                id: "v=",
                src: "https://www.youtube.com/embed/pDa9NS7JPJk",
              },
            },
          },
          // other options
      ...
      if ($(".testimonial_icon_11 .video").length > 0) {
        $(".testimonial_icon_11 .video").magnificPopup({
          type: "iframe",
          iframe: {
            markup:
              '<div class="mfp-iframe-scaler">' +
            ...
            patterns: {
              youtube: {
                index: "youtube.com/",
                id: "v=",
                src: "https://www.youtube.com/embed/oN0Cc5i03P8",
              },
            },
          },
          // other options
      ...
      if ($(".testimonial_icon_10 .video").length > 0) {
        $(".testimonial_icon_10 .video").magnificPopup({
          type: "iframe",
          iframe: {
            markup:
              '<div class="mfp-iframe-scaler">' +
            ...
            patterns: {
              youtube: {
                index: "youtube.com/",
                id: "v=",
                src: "https://www.youtube.com/embed/SxUyWQBXago",
              },
            },
          },
          // other options
      ...
      if ($(".testimonial_icon_9 .video").length > 0) {
        $(".testimonial_icon_9 .video").magnificPopup({
          type: "iframe",
          iframe: {
            markup:
              '<div class="mfp-iframe-scaler">' +
            ...
            patterns: {
              youtube: {
                index: "youtube.com/",
                id: "v=",
                src: "https://www.youtube.com/embed/SFLD9ZAe4eg",
              },
            },
          },
          // other options
      ...
      if ($(".testimonial_icon_8 .video").length > 0) {
        $(".testimonial_icon_8 .video").magnificPopup({
          type: "iframe",
          iframe: {
            markup:
              '<div class="mfp-iframe-scaler">' +
            ...
            patterns: {
              youtube: {
                index: "youtube.com/",
                id: "v=",
                src: "https://www.youtube.com/embed/4vg_YjJ-DCw",
              },
            },
          },
          // other options
      ...
      if ($(".testimonial_icon_7 .video").length > 0) {
        $(".testimonial_icon_7 .video").magnificPopup({
          type: "iframe",
          iframe: {
            markup:
              '<div class="mfp-iframe-scaler">' +
            ...
            patterns: {
              youtube: {
                index: "youtube.com/",
                id: "v=",
                src: "https://www.youtube.com/embed/pNCCREw85dg",
              },
            },
          },
          // other options
      ...
      if ($(".testimonial_icon_6 .video").length > 0) {
        $(".testimonial_icon_6 .video").magnificPopup({
          type: "iframe",
          iframe: {
            markup:
              '<div class="mfp-iframe-scaler">' +
            ...
            patterns: {
              youtube: {
                index: "youtube.com/",
                id: "v=",
                src: "https://www.youtube.com/embed/DVaCQvK4n48",
              },
            },
          },
          // other options
      ...
      if ($(".testimonial_icon_5 .video").length > 0) {
        $(".testimonial_icon_5 .video").magnificPopup({
          type: "iframe",
          iframe: {
            markup:
              '<div class="mfp-iframe-scaler">' +
            ...
            patterns: {
              youtube: {
                index: "youtube.com/",
                id: "v=",
                src: "https://www.youtube.com/embed/rliEVm4QRtk",
              },
            },
          },
          // other options
      ...
      if ($(".testimonial_icon_4 .video").length > 0) {
        $(".testimonial_icon_4 .video").magnificPopup({
          type: "iframe",
          iframe: {
            markup:
              '<div class="mfp-iframe-scaler">' +
            ...
            patterns: {
              youtube: {
                index: "youtube.com/",
                id: "v=",
                src: "https://www.youtube.com/embed/9j0uLsNH37Q",
              },
            },
          },
          // other options
      ...
      if ($(".testimonial_icon_3 .video").length > 0) {
        $(".testimonial_icon_3 .video").magnificPopup({
          type: "iframe",
          iframe: {
            markup:
              '<div class="mfp-iframe-scaler">' +
            ...
            patterns: {
              youtube: {
                index: "youtube.com/",
                id: "v=",
                src: "https://www.youtube.com/embed/4WXCHTSjlSo",
              },
            },
          },
          // other options
      ...
      if ($(".testimonial_icon_2 .video").length > 0) {
        $(".testimonial_icon_2 .video").magnificPopup({
          type: "iframe",
          iframe: {
            markup:
              '<div class="mfp-iframe-scaler">' +
            ...
            patterns: {
              youtube: {
                index: "youtube.com/",
                id: "v=",
                src: "https://www.youtube.com/embed/qtZsnA0hkLY",
              },
            },
          },
          // other options
      ...
      if ($(".testimonial_icon_1 .video").length > 0) {
        $(".testimonial_icon_1 .video").magnificPopup({
          type: "iframe",
          iframe: {
            markup:
              '<div class="mfp-iframe-scaler">' +
            ...
            patterns: {
              youtube: {
                index: "youtube.com/",
                id: "v=",
                src: "https://www.youtube.com/embed/90Fl8HQ9zbU",
              },
            },
          },
          // other options
